...
function Sidebar({hide}) {
    const asideClass = ` flex-col z-[99999] w-full  animate-Right-To-Left h-screen px-5 py-8 overflow-y-auto bg-white fixed top-0 bottom-0 right-0 ${ hide ? "flex" : "hidden"} border-r rtl:border-r-0 rtl:border-l `
  return (
    ...
    <div class="flex flex-col justify-between flex-1 mt-6">
        <nav class="-mx-3 space-y-6 ">
            ...
            <div class="space-y-3 ">
                <label class="px-3 text-xs text-gray-500 uppercase dark:text-gray-400">Orders</label>
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg  hover:bg-gray-100 da hover:text-gray-700" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                ...
                <a class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg  hover:bg-gray-100  hover:text-gray-700" href="#">
                    ...
                    <span class="mx-2 text-sm font-medium">Customer Support</span>
                </a>
            </div>
